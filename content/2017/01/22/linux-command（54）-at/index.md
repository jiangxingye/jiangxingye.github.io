...
date: 2017-01-22T02:23:44+08:00
lastmod: 2019-09-02T13:03:00+08:00
slug: "linux-command（54）-at"
categories: [运维]
tags: [linux命令]
description: "每天一个linux命令（54）: at"
---
...
透过这个说明，我们知道 /etc/at.allow 是管理较为严格的方式，而 /etc/at.deny 则较为松散 (因为帐号没有在该文件中，就能够运行 at 了)。在一般的 distributions 当中，由于假设系统上的所有用户都是可信任的， 因此系统通常会保留一个空的 /etc/at.deny 文件，意思是允许所有人使用 at 命令的意思 (您可以自行检查一下该文件)。
